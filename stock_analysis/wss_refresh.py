...
def _normalize_header(value: str) -> str:
    ...
    aliases = {
        ...
        "护城河": "moat",
        "moat": "moat",
        "商业验证": "commercial_validation",
        "商业化验证": "commercial_validation",
        "commercialvalidation": "commercial_validation",
...
def parse_research_html(html: str) -> Dict[str, Any]:
    ...
    for row in _extract_tables(html):
        ...
        tickers[ticker] = {
            ...
            "moat": row.get("moat", ""),
            "commercial_validation": row.get("commercial_validation", ""),
            "financial_quality": row.get("financial_quality", ""),
            "industry_position": row.get("industry_position", ""),
            "valuation_odds": row.get("valuation_odds", ""),
            "risk_deduction": row.get("risk_deduction", ""),
