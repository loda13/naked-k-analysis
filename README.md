...
当前版本：[v1.5.0](https://github.com/loda13/stock-ma-analysis/releases/tag/v1.5.0)
...
- **数据质量门槛**：中期日线或裸 K 数据过旧、行数不足时，会给出警告并阻断买入 / 小仓试错。
...
- **数据质量阻断**：短期 / 中期 / 长期 / 裸 K 会分别检查行数和最新日期；中期日线或裸 K 不可信时，买入和小仓试错都会降级为观望。
